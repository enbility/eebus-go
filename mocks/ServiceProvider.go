...
func (_m *ServiceProvider) VisibleMDNSRecordsUpdated(entries []*ship_goapi.MdnsEntry) {
	_m.Called(entries)
}
...
func (_c *ServiceProvider_VisibleMDNSRecordsUpdated_Call) Run(run func(entries []*ship_goapi.MdnsEntry)) *ServiceProvider_VisibleMDNSRecordsUpdated_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]*ship_goapi.MdnsEntry))
	})
	return _c
}
...
func (_c *ServiceProvider_VisibleMDNSRecordsUpdated_Call) RunAndReturn(run func([]*ship_goapi.MdnsEntry)) *ServiceProvider_VisibleMDNSRecordsUpdated_Call {
	_c.Call.Return(run)
	return _c
}
