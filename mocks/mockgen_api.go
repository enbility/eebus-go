...
// Source: github.com/enbility/eebus-go/api (interfaces: ServiceProvider)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/mockgen_api.go -package=mocks github.com/enbility/eebus-go/api ServiceProvider
//
...
func (m *MockServiceProvider) VisibleMDNSRecordsUpdated(arg0 []*api0.MdnsEntry) {
	m.ctrl.T.Helper()
