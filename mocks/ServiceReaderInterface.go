...
func (_m *ServiceReaderInterface) AllowWaitingForTrust(ski string) bool {
	ret := _m.Called(ski)
...
// ServiceReaderInterface_AllowWaitingForTrust_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AllowWaitingForTrust'
type ServiceReaderInterface_AllowWaitingForTrust_Call struct {
	*mock.Call
}

// AllowWaitingForTrust is a helper method to define mock.On call
//   - ski string
func (_e *ServiceReaderInterface_Expecter) AllowWaitingForTrust(ski interface{}) *ServiceReaderInterface_AllowWaitingForTrust_Call {
	return &ServiceReaderInterface_AllowWaitingForTrust_Call{Call: _e.mock.On("AllowWaitingForTrust", ski)}
}

func (_c *ServiceReaderInterface_AllowWaitingForTrust_Call) Run(run func(ski string)) *ServiceReaderInterface_AllowWaitingForTrust_Call {
...
func (_c *ServiceReaderInterface_AllowWaitingForTrust_Call) Return(_a0 bool) *ServiceReaderInterface_AllowWaitingForTrust_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ServiceReaderInterface_AllowWaitingForTrust_Call) RunAndReturn(run func(string) bool) *ServiceReaderInterface_AllowWaitingForTrust_Call {
	_c.Call.Return(run)
	return _c
}
