...
// GetOrAddIdForDescription provides a mock function with given fields: electricalConnectionDescription
func (_m *ElectricalConnectionServerInterface) GetOrAddIdForDescription(electricalConnectionDescription model.ElectricalConnectionDescriptionDataType) (*model.ElectricalConnectionIdType, error) {
	ret := _m.Called(electricalConnectionDescription)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(model.ElectricalConnectionDescriptionDataType) (*model.ElectricalConnectionIdType, error)); ok {
		return rf(electricalConnectionDescription)
	}
	if rf, ok := ret.Get(0).(func(model.ElectricalConnectionDescriptionDataType) *model.ElectricalConnectionIdType); ok {
		r0 = rf(electricalConnectionDescription)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(model.ElectricalConnectionDescriptionDataType) error); ok {
		r1 = rf(electricalConnectionDescription)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *ElectricalConnectionServerInterface_GetOrAddIdForDescription_Call) Return(_a0 *model.ElectricalConnectionIdType, _a1 error) *ElectricalConnectionServerInterface_GetOrAddIdForDescription_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ElectricalConnectionServerInterface_GetOrAddIdForDescription_Call) RunAndReturn(run func(model.ElectricalConnectionDescriptionDataType) (*model.ElectricalConnectionIdType, error)) *ElectricalConnectionServerInterface_GetOrAddIdForDescription_Call {
	_c.Call.Return(run)
	return _c
}
