...
func (_m *DeviceConfigurationServerInterface) CheckEventPayloadDataForFilter(payloadData any, filter any) bool {
...
func (_c *DeviceConfigurationServerInterface_CheckEventPayloadDataForFilter_Call) RunAndReturn(run func(any, any) bool) *DeviceConfigurationServerInterface_CheckEventPayloadDataForFilter_Call {
	_c.Call.Return(run)
	return _c
}
