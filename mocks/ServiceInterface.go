...
func (_m *ServiceInterface) InitiateOrApprovePairingWithSKI(ski string) {
	_m.Called(ski)
}

// ServiceInterface_InitiateOrApprovePairingWithSKI_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InitiateOrApprovePairingWithSKI'
type ServiceInterface_InitiateOrApprovePairingWithSKI_Call struct {
	*mock.Call
}

// InitiateOrApprovePairingWithSKI is a helper method to define mock.On call
//   - ski string
func (_e *ServiceInterface_Expecter) InitiateOrApprovePairingWithSKI(ski interface{}) *ServiceInterface_InitiateOrApprovePairingWithSKI_Call {
	return &ServiceInterface_InitiateOrApprovePairingWithSKI_Call{Call: _e.mock.On("InitiateOrApprovePairingWithSKI", ski)}
}

func (_c *ServiceInterface_InitiateOrApprovePairingWithSKI_Call) Run(run func(ski string)) *ServiceInterface_InitiateOrApprovePairingWithSKI_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *ServiceInterface_InitiateOrApprovePairingWithSKI_Call) Return() *ServiceInterface_InitiateOrApprovePairingWithSKI_Call {
	_c.Call.Return()
	return _c
}

func (_c *ServiceInterface_InitiateOrApprovePairingWithSKI_Call) RunAndReturn(run func(string)) *ServiceInterface_InitiateOrApprovePairingWithSKI_Call {
	_c.Call.Return(run)
	return _c
}
