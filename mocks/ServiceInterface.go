...
func (_m *ServiceInterface) AddUseCase(useCase api.UseCaseInterface) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(api.UseCaseInterface) error); ok {
		r0 = rf(useCase)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *ServiceInterface_AddUseCase_Call) Return(_a0 error) *ServiceInterface_AddUseCase_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ServiceInterface_AddUseCase_Call) RunAndReturn(run func(api.UseCaseInterface) error) *ServiceInterface_AddUseCase_Call {
	_c.Call.Return(run)
	return _c
}
...
// IsAutoAcceptEnabled provides a mock function with no fields
...
// LocalDevice provides a mock function with no fields
...
// LocalService provides a mock function with no fields
...
// QRCodeText provides a mock function with no fields
...
// RegisterRemoteSKI provides a mock function with given fields: ski, shipID
func (_m *ServiceInterface) RegisterRemoteSKI(ski string, shipID string) {
...
func (_c *ServiceInterface_RegisterRemoteSKI_Call) RunAndReturn(run func(string, string)) *ServiceInterface_RegisterRemoteSKI_Call {
	_c.Run(run)
	return _c
}
