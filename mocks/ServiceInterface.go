...
func (_m *ServiceInterface) InitiatePairingWithSKI(ski string) {
	_m.Called(ski)
}

// ServiceInterface_InitiatePairingWithSKI_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InitiatePairingWithSKI'
type ServiceInterface_InitiatePairingWithSKI_Call struct {
	*mock.Call
}

// InitiatePairingWithSKI is a helper method to define mock.On call
//   - ski string
func (_e *ServiceInterface_Expecter) InitiatePairingWithSKI(ski interface{}) *ServiceInterface_InitiatePairingWithSKI_Call {
	return &ServiceInterface_InitiatePairingWithSKI_Call{Call: _e.mock.On("InitiatePairingWithSKI", ski)}
}

func (_c *ServiceInterface_InitiatePairingWithSKI_Call) Run(run func(ski string)) *ServiceInterface_InitiatePairingWithSKI_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *ServiceInterface_InitiatePairingWithSKI_Call) Return() *ServiceInterface_InitiatePairingWithSKI_Call {
	_c.Call.Return()
	return _c
}

func (_c *ServiceInterface_InitiatePairingWithSKI_Call) RunAndReturn(run func(string)) *ServiceInterface_InitiatePairingWithSKI_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ServiceInterface) RegisterRemoteSKI(ski string, enable bool) {
...
//   - ski string
//   - enable bool
func (_e *ServiceInterface_Expecter) RegisterRemoteSKI(ski interface{}, enable interface{}) *ServiceInterface_RegisterRemoteSKI_Call {
	return &ServiceInterface_RegisterRemoteSKI_Call{Call: _e.mock.On("RegisterRemoteSKI", ski, enable)}
}

func (_c *ServiceInterface_RegisterRemoteSKI_Call) Run(run func(ski string, enable bool)) *ServiceInterface_RegisterRemoteSKI_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ServiceInterface_RegisterRemoteSKI_Call) RunAndReturn(run func(string, bool)) *ServiceInterface_RegisterRemoteSKI_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ServiceInterface) StartBrowseMdnsEntries() {
	_m.Called()
}

// ServiceInterface_StartBrowseMdnsEntries_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartBrowseMdnsEntries'
type ServiceInterface_StartBrowseMdnsEntries_Call struct {
	*mock.Call
}

// StartBrowseMdnsEntries is a helper method to define mock.On call
func (_e *ServiceInterface_Expecter) StartBrowseMdnsEntries() *ServiceInterface_StartBrowseMdnsEntries_Call {
	return &ServiceInterface_StartBrowseMdnsEntries_Call{Call: _e.mock.On("StartBrowseMdnsEntries")}
}

func (_c *ServiceInterface_StartBrowseMdnsEntries_Call) Run(run func()) *ServiceInterface_StartBrowseMdnsEntries_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ServiceInterface_StartBrowseMdnsEntries_Call) Return() *ServiceInterface_StartBrowseMdnsEntries_Call {
	_c.Call.Return()
	return _c
}

func (_c *ServiceInterface_StartBrowseMdnsEntries_Call) RunAndReturn(run func()) *ServiceInterface_StartBrowseMdnsEntries_Call {
	_c.Call.Return(run)
	return _c
}

// StopBrowseMdnsEntries provides a mock function with given fields:
func (_m *ServiceInterface) StopBrowseMdnsEntries() {
	_m.Called()
}

// ServiceInterface_StopBrowseMdnsEntries_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StopBrowseMdnsEntries'
type ServiceInterface_StopBrowseMdnsEntries_Call struct {
	*mock.Call
}

// StopBrowseMdnsEntries is a helper method to define mock.On call
func (_e *ServiceInterface_Expecter) StopBrowseMdnsEntries() *ServiceInterface_StopBrowseMdnsEntries_Call {
	return &ServiceInterface_StopBrowseMdnsEntries_Call{Call: _e.mock.On("StopBrowseMdnsEntries")}
}

func (_c *ServiceInterface_StopBrowseMdnsEntries_Call) Run(run func()) *ServiceInterface_StopBrowseMdnsEntries_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ServiceInterface_StopBrowseMdnsEntries_Call) Return() *ServiceInterface_StopBrowseMdnsEntries_Call {
	_c.Call.Return()
	return _c
}

func (_c *ServiceInterface_StopBrowseMdnsEntries_Call) RunAndReturn(run func()) *ServiceInterface_StopBrowseMdnsEntries_Call {
	_c.Call.Return(run)
	return _c
}
