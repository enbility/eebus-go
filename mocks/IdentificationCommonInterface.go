...
func (_m *IdentificationCommonInterface) CheckEventPayloadDataForFilter(payloadData any) bool {
...
func (_c *IdentificationCommonInterface_CheckEventPayloadDataForFilter_Call) RunAndReturn(run func(any) bool) *IdentificationCommonInterface_CheckEventPayloadDataForFilter_Call {
	_c.Call.Return(run)
	return _c
}
