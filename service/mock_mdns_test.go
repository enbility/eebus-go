...
//
//	mockgen -destination=mock_mdns_test.go -package=service github.com/enbility/eebus-go/service MdnsSearch,MdnsService
//
...
func (mr *MockMdnsSearchMockRecorder) ReportMdnsEntries(arg0 any) *gomock.Call {
