...
func (e *MDSF) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *MDSF) hvacOverrunDataUpdate(payload spineapi.EventPayload) {
...
func (e *MDSF) hvacSystemFunctionDataUpdate(payload spineapi.EventPayload) {
