...
// handle SPINE events
func (e *MRCSF) HandleEvent(payload spineapi.EventPayload) {
...
func (e *MRCSF) hvacRoomConnected(entity spineapi.EntityRemoteInterface) {
...
func (e *MRCSF) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *MRCSF) hvacSystemFunctionDataUpdate(payload spineapi.EventPayload) {
