...
// Add support for the Monitoring of Room Heating System Function (MRHSF)
// use case as a Monitoring Appliance actor
//
// Parameters:
//   - localEntity: The local entity which should support the use case
//   - eventCB: The callback to be called when an event is triggered (optional, can be nil)
func NewMRHSF(localEntity spineapi.EntityLocalInterface, eventCB api.EntityEventCallback) *MRHSF {
...
func (e *MRHSF) AddFeatures() error {
	// client features
