...
//
// the outdoor temperature sensor may announce the temperature in degC, degF
// or K; the value is converted to the requested unit (one of degC, degF, K)
//
// possible errors:
...
//   - and others
func (e *MOT) Temperature(entity spineapi.EntityRemoteInterface, unit model.UnitOfMeasurementType) (float64, error) {
