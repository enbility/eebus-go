...
func (_m *CemEVSECCInterface) RemoteEntities() []eebus_goapi.RemoteEntityScenarios {
	ret := _m.Called()
...
// CemEVSECCInterface_RemoteEntities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoteEntities'
type CemEVSECCInterface_RemoteEntities_Call struct {
	*mock.Call
}

// RemoteEntities is a helper method to define mock.On call
func (_e *CemEVSECCInterface_Expecter) RemoteEntities() *CemEVSECCInterface_RemoteEntities_Call {
	return &CemEVSECCInterface_RemoteEntities_Call{Call: _e.mock.On("RemoteEntities")}
}

func (_c *CemEVSECCInterface_RemoteEntities_Call) Run(run func()) *CemEVSECCInterface_RemoteEntities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *CemEVSECCInterface_RemoteEntities_Call) Return(_a0 []eebus_goapi.RemoteEntityScenarios) *CemEVSECCInterface_RemoteEntities_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CemEVSECCInterface_RemoteEntities_Call) RunAndReturn(run func() []eebus_goapi.RemoteEntityScenarios) *CemEVSECCInterface_RemoteEntities_Call {
	_c.Call.Return(run)
	return _c
}
