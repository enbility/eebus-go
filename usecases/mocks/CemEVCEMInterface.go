...
func (_m *CemEVCEMInterface) HasSupportForUseCaseScenarios(entity spine_goapi.EntityRemoteInterface, scenarios []model.UseCaseScenarioSupportType) bool {
...
// CemEVCEMInterface_HasSupportForUseCaseScenarios_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasSupportForUseCaseScenarios'
type CemEVCEMInterface_HasSupportForUseCaseScenarios_Call struct {
	*mock.Call
}
...
func (_e *CemEVCEMInterface_Expecter) HasSupportForUseCaseScenarios(entity interface{}, scenarios interface{}) *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call {
	return &CemEVCEMInterface_HasSupportForUseCaseScenarios_Call{Call: _e.mock.On("HasSupportForUseCaseScenarios", entity, scenarios)}
}

func (_c *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call) Run(run func(entity spine_goapi.EntityRemoteInterface, scenarios []model.UseCaseScenarioSupportType)) *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call) Return(_a0 bool) *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call) RunAndReturn(run func(spine_goapi.EntityRemoteInterface, []model.UseCaseScenarioSupportType) bool) *CemEVCEMInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CemEVCEMInterface) RemoteEntities() []eebus_goapi.RemoteEntityScenarios {
	ret := _m.Called()
...
// CemEVCEMInterface_RemoteEntities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoteEntities'
type CemEVCEMInterface_RemoteEntities_Call struct {
	*mock.Call
}

// RemoteEntities is a helper method to define mock.On call
func (_e *CemEVCEMInterface_Expecter) RemoteEntities() *CemEVCEMInterface_RemoteEntities_Call {
	return &CemEVCEMInterface_RemoteEntities_Call{Call: _e.mock.On("RemoteEntities")}
}

func (_c *CemEVCEMInterface_RemoteEntities_Call) Run(run func()) *CemEVCEMInterface_RemoteEntities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *CemEVCEMInterface_RemoteEntities_Call) Return(_a0 []eebus_goapi.RemoteEntityScenarios) *CemEVCEMInterface_RemoteEntities_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CemEVCEMInterface_RemoteEntities_Call) RunAndReturn(run func() []eebus_goapi.RemoteEntityScenarios) *CemEVCEMInterface_RemoteEntities_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CemEVCEMInterface) SupportedUseCaseScenarios(entity spine_goapi.EntityRemoteInterface) []model.UseCaseScenarioSupportType {
	ret := _m.Called(entity)
...
// CemEVCEMInterface_SupportedUseCaseScenarios_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SupportedUseCaseScenarios'
type CemEVCEMInterface_SupportedUseCaseScenarios_Call struct {
	*mock.Call
}

// SupportedUseCaseScenarios is a helper method to define mock.On call
//   - entity spine_goapi.EntityRemoteInterface
func (_e *CemEVCEMInterface_Expecter) SupportedUseCaseScenarios(entity interface{}) *CemEVCEMInterface_SupportedUseCaseScenarios_Call {
	return &CemEVCEMInterface_SupportedUseCaseScenarios_Call{Call: _e.mock.On("SupportedUseCaseScenarios", entity)}
}

func (_c *CemEVCEMInterface_SupportedUseCaseScenarios_Call) Run(run func(entity spine_goapi.EntityRemoteInterface)) *CemEVCEMInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(spine_goapi.EntityRemoteInterface))
	})
	return _c
...
func (_c *CemEVCEMInterface_SupportedUseCaseScenarios_Call) Return(_a0 []model.UseCaseScenarioSupportType) *CemEVCEMInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *CemEVCEMInterface_SupportedUseCaseScenarios_Call) RunAndReturn(run func(spine_goapi.EntityRemoteInterface) []model.UseCaseScenarioSupportType) *CemEVCEMInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Return(run)
	return _c
}
