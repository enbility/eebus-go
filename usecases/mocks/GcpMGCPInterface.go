...
func (_m *GcpMGCPInterface) HasSupportForUseCaseScenarios(entity spine_goapi.EntityRemoteInterface, scenarios []model.UseCaseScenarioSupportType) bool {
...
// GcpMGCPInterface_HasSupportForUseCaseScenarios_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasSupportForUseCaseScenarios'
type GcpMGCPInterface_HasSupportForUseCaseScenarios_Call struct {
	*mock.Call
}
...
func (_e *GcpMGCPInterface_Expecter) HasSupportForUseCaseScenarios(entity interface{}, scenarios interface{}) *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call {
	return &GcpMGCPInterface_HasSupportForUseCaseScenarios_Call{Call: _e.mock.On("HasSupportForUseCaseScenarios", entity, scenarios)}
}

func (_c *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call) Run(run func(entity spine_goapi.EntityRemoteInterface, scenarios []model.UseCaseScenarioSupportType)) *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call) Return(_a0 bool) *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call) RunAndReturn(run func(spine_goapi.EntityRemoteInterface, []model.UseCaseScenarioSupportType) bool) *GcpMGCPInterface_HasSupportForUseCaseScenarios_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GcpMGCPInterface) RemoteEntities() []eebus_goapi.RemoteEntityScenarios {
	ret := _m.Called()
...
// GcpMGCPInterface_RemoteEntities_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoteEntities'
type GcpMGCPInterface_RemoteEntities_Call struct {
	*mock.Call
}

// RemoteEntities is a helper method to define mock.On call
func (_e *GcpMGCPInterface_Expecter) RemoteEntities() *GcpMGCPInterface_RemoteEntities_Call {
	return &GcpMGCPInterface_RemoteEntities_Call{Call: _e.mock.On("RemoteEntities")}
}

func (_c *GcpMGCPInterface_RemoteEntities_Call) Run(run func()) *GcpMGCPInterface_RemoteEntities_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *GcpMGCPInterface_RemoteEntities_Call) Return(_a0 []eebus_goapi.RemoteEntityScenarios) *GcpMGCPInterface_RemoteEntities_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GcpMGCPInterface_RemoteEntities_Call) RunAndReturn(run func() []eebus_goapi.RemoteEntityScenarios) *GcpMGCPInterface_RemoteEntities_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GcpMGCPInterface) SupportedUseCaseScenarios(entity spine_goapi.EntityRemoteInterface) []model.UseCaseScenarioSupportType {
	ret := _m.Called(entity)
...
// GcpMGCPInterface_SupportedUseCaseScenarios_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SupportedUseCaseScenarios'
type GcpMGCPInterface_SupportedUseCaseScenarios_Call struct {
	*mock.Call
}

// SupportedUseCaseScenarios is a helper method to define mock.On call
//   - entity spine_goapi.EntityRemoteInterface
func (_e *GcpMGCPInterface_Expecter) SupportedUseCaseScenarios(entity interface{}) *GcpMGCPInterface_SupportedUseCaseScenarios_Call {
	return &GcpMGCPInterface_SupportedUseCaseScenarios_Call{Call: _e.mock.On("SupportedUseCaseScenarios", entity)}
}

func (_c *GcpMGCPInterface_SupportedUseCaseScenarios_Call) Run(run func(entity spine_goapi.EntityRemoteInterface)) *GcpMGCPInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(spine_goapi.EntityRemoteInterface))
	})
	return _c
...
func (_c *GcpMGCPInterface_SupportedUseCaseScenarios_Call) Return(_a0 []model.UseCaseScenarioSupportType) *GcpMGCPInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GcpMGCPInterface_SupportedUseCaseScenarios_Call) RunAndReturn(run func(spine_goapi.EntityRemoteInterface) []model.UseCaseScenarioSupportType) *GcpMGCPInterface_SupportedUseCaseScenarios_Call {
	_c.Call.Return(run)
	return _c
}
