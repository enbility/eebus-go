...
// handle SPINE events
func (e *CRCT) HandleEvent(payload spineapi.EventPayload) {
...
func (e *CRCT) hvacRoomConnected(entity spineapi.EntityRemoteInterface) {
...
func (e *CRCT) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *CRCT) setpointDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if setpoint, err := client.NewSetpoint(e.LocalEntity, entity); err == nil {
...
func (e *CRCT) setpointDataUpdate(payload spineapi.EventPayload) {
...
func (e *CRCT) setpointConstraintsDataUpdate(payload spineapi.EventPayload) {
