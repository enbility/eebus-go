...
// return the current room cooling temperature setpoints of the HVAC room entity,
// returns ErrDataNotAvailable if no such data is (yet) available
func (e *CRCT) Setpoints(entity spineapi.EntityRemoteInterface) ([]ucapi.Setpoint, error) {
...
// returns ErrDataNotAvailable if no such data is (yet) available
func (e *CRCT) SetpointConstraints(entity spineapi.EntityRemoteInterface) ([]ucapi.SetpointConstraints, error) {
	if !e.IsCompatibleEntityType(entity) {
		return nil, api.ErrNoCompatibleEntity
	}
...
// write the room cooling temperature setpoint in degree Celsius for a cooling
// operation mode (on, off or eco), returns ErrNotSupported if it is not changeable
func (e *CRCT) WriteSetpoint(
...
// return the ids of the setpoints related to the cooling system function
func (e *CRCT) setpointIds(entity spineapi.EntityRemoteInterface) ([]model.SetpointIdType, error) {
...
// return the id of the setpoint related to the given cooling operation mode
func (e *CRCT) setpointIdForMode(
	entity spineapi.EntityRemoteInterface,
	mode ucapi.HvacOperationModeType,
...
// return the setpoint relations of the cooling system function
func (e *CRCT) setpointRelations(
	entity spineapi.EntityRemoteInterface,
