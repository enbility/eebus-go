...
func (s *CaCRCTSuite) Test_Events() {
...
func (s *CaCRCTSuite) Test_Failures() {
...
func (s *CaCRCTSuite) Test_setpointDataUpdate() {
	payload := spineapi.EventPayload{
		Ski:    remoteSki,
...
func (s *CaCRCTSuite) Test_setpointConstraintsDataUpdate() {
	payload := spineapi.EventPayload{
		Ski:    remoteSki,
		Entity: s.hvacRoomEntity,
	}
