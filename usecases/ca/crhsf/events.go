...
func (e *CRHSF) hvacRoomConnected(entity spineapi.EntityRemoteInterface) {
...
func (e *CRHSF) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *CRHSF) hvacSystemFunctionDataUpdate(payload spineapi.EventPayload) {
