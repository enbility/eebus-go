...
func (s *CaCRHSFSuite) Test_WriteOperationMode_ChangeabilityOmitted() {
...
func (s *CaCRHSFSuite) Test_WriteOperationMode_UnrelatedMode() {
	s.addHvacData(util.Ptr(true))

	// add a mode that exists globally but is not related to the heating function
...
func (s *CaCRHSFSuite) Test_WriteOperationMode_WriteNotAdvertised() {
	s.addHvacData(util.Ptr(true))
