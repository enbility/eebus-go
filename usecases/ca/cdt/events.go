...
func (e *CDT) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *CDT) setpointDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if setpoint, err := client.NewSetpoint(e.LocalEntity, entity); err == nil {
...
func (e *CDT) setpointDataUpdate(payload spineapi.EventPayload) {
...
func (e *CDT) setpointConstraintsDataUpdate(payload spineapi.EventPayload) {
