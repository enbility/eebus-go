...
func (e *CRCSF) hvacRoomConnected(entity spineapi.EntityRemoteInterface) {
...
func (e *CRCSF) hvacSystemFunctionDescriptionDataUpdate(entity spineapi.EntityRemoteInterface) {
	if hvac, err := client.NewHvac(e.LocalEntity, entity); err == nil {
...
func (e *CRCSF) hvacSystemFunctionDataUpdate(payload spineapi.EventPayload) {
