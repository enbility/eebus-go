...
func (s *CaCRHTSuite) Test_Events() {
...
func (s *CaCRHTSuite) Test_Failures() {
...
func (s *CaCRHTSuite) Test_setpointDataUpdate() {
	payload := spineapi.EventPayload{
		Ski:    remoteSki,
...
func (s *CaCRHTSuite) Test_setpointConstraintsDataUpdate() {
	payload := spineapi.EventPayload{
		Ski:    remoteSki,
		Entity: s.hvacRoomEntity,
	}
